...
use super::rate_limit::EndpointType;

/// Upbit-specific rate limiter trait
///
/// This trait defines the interface for Upbit rate limiting with endpoint-specific controls.
/// It can be implemented for both native and WASM environments.
#[async_trait]
pub trait UpbitRateLimiter: Send + Sync {
